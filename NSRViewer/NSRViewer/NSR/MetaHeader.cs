...
namespace NSRViewer.NSR
{
    public struct MetaHeader
    {
        ...
        private static readonly Dictionary<uint, string> Zones = new Dictionary<uint, string>
        {
            ...
            { 617, "Copacabana Beta" },
            { 618, "DEP Moisture Farm: Skirmish TDM" },
            { 619, "The Dam" },
            ...
            { 1051, "Baneclaw Lair" },
            { 1052, "Sertao ARES Hydroelectric Facility" },
